...
const prerender = ["/", "/guardian-upgrade-costs", "/immortal-guardians", "/unlock-order", "/treasure-upgrade-costs", "/hard-gameplay", "/unlock-order-hard", "/guild-battle", "/fix", "/lucky-defense", "/guardian-upgrade-costs", "/lance-kitty", "/hell-mode", "/testttt", "/hell-mode-basics", "/hell-mode-bosses", "/magic-hell-build", "/sb-mg", "/mythic-categories", "/stun-guide", "/defense-reduction", "/reaper-dian", "/new-page", "/immortal-guardians", "/immortal-main", "/mp-regen", "/attack-speed", "/newbie-quests", "/safe-box-table", "/pets", "/indy-treasures", "/daily-fortunes", "/unlock-treasures", "/exclusive-treasures"];
